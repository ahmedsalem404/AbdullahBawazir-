...
export function DashboardToolbar({
  ...
  return (
    <div className="w-full rounded-[2rem] border border-slate-200/40 bg-slate-100/50 p-2 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-550 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.04)]">
      <style>{`
        /* إخفاء أيقونة التقويم الافتراضية في سفاري/آيفون */
        ...
        /* ضبط ظهور حقل التاريخ على الايفون وسفاري */
        input[type="date"] {
      ...
      `}</style>
      <div className="w-full rounded-[calc(2rem-0.5rem)] bg-white p-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between border border-white/60 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8)]">
        <button
          onClick={onAdd}
        ...
        <div className="flex flex-col gap-3 w-full lg:w-auto lg:flex-row lg:items-center">
          ...
          <button
            ...
            type="button"
            className={`flex h-12 w-full lg:w-auto items-center justify-center gap-2 rounded-2xl border px-4 font-bold transition-all duration-300 active:scale-95 cursor-pointer ${
              onlyUnderWork
          ...
          <label className="relative block w-full lg:w-auto">
            ...
            <input
              ...
              className="h-12 w-full rounded-2xl border border-brand-line bg-white px-10 text-base outline-none transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] focus:border-brand-green focus:ring-4 focus:ring-brand-green/12 placeholder-slate-400 lg:w-72"
            />
          </label>
          <label className="relative block w-full lg:w-auto">
            <CalendarDays
            ...
            <input
              ...
              type="date"
              className="h-12 w-full rounded-2xl border border-brand-line bg-white px-10 text-base outline-none transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] focus:border-brand-green focus:ring-4 focus:ring-brand-green/12 lg:w-52"
            />
          </label>
        </div>
      </div>
